...
public class RedisUtil {
    public static final String prefix = "Goodnight2022:";
    ...
    /**
     * 删除缓存
     * @param keys Collection 键
     */
    public void deleteCollectionOriginal(Collection<String> keys) {
     ...
     * @param recordId ID
     */
    public void delStream(String key, String recordId) {
        redisTemplate.opsForStream().delete(prefix + key, recordId);
    }
     ...
     * @param recordId 消息ID
     */
    public void ackMessage(String key, String group, String recordId) {
        redisTemplate.opsForStream().acknowledge(prefix + key, group, recordId);
    }
     ...
     * @param recordId 消息ID
     */
    public void ackAndDelMessage(String key, String group, String recordId) {
        ackMessage(key, group, recordId);
        delStream(key, recordId);
    }
